...
if(word_length <= board_w)
{
    ...
    for(i = 0; i <= word_length; i++)
    {
        ...
        {
            if(ds_grid_get(board, xx + i, yy) == letra_atual)
            {
                letra_num += 1;
                letra_atual = string_char_at(word, letra_num);
            }
            ...
            {
                if(ds_grid_get(board, xx + i, yy) == 0)
                {
                    letra_num += 1;
                    letra_atual = string_char_at(word, letra_num);
                }
        ...
        else
        {
            ...
            for(add = 0; add < word_length; add++)
            {
                ...
                ds_map_replace(map_cell[xx + add, yy], "id", cell_id);
                
                ativo = ds_map_find_value(map_cell[xx + add, yy], "ativo");
                
                ativo += 1;
                
                ds_map_replace(map_cell[xx + add, yy], "ativo", ativo);
                //FIM VALOR ATIVO
                
                if(add == 0)
                {
                    ds_map_add(map_cell[xx + add, yy], "word_" + string(ativo), word);
                    ds_map_replace(map_cell[xx + add, yy], "first", 1);
                    
                    if(reversed == 1)
                    {
                        ds_map_replace(map_cell[xx + add, yy], "reversed", 1);
                    }
                }
                else
                {
                    ...
                    {
                        ds_map_add(map_cell[xx + add, yy], "word_" + string(ativo), word);
                        ds_map_replace(map_cell[xx + add, yy], "last", 1);
                ...
                ds_grid_set(board, xx + add, yy, letra_atual);
